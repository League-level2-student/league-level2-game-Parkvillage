...
public class Screen2 extends Screen implements ActionListener, MouseListener {
    ...
    public Screen2(Level2GameTemplate game) {
        ...
        labelGuessSong = new JLabel( "Guess the noise!" );
        ...
        labelTitle.setText( "Multiple swing layouts & score: " + counter );
        labelTitleImage = visual.createLabelImage( "hi.png", 400, 200 );
    ...
    public void setup() {
        game.frame.setTitle( "Guess the sound or somethomg" );

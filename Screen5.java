...
public class Screen5 extends Screen implements ActionListener {
    ...
    public void paintComponent(Graphics g) {
        ...
        g.setFont( titleFont );
        g.drawString( "Clicky game", 150, 300 );
        
        g.setFont( new Font( "Courier New", Font.PLAIN, 32 ) );
        g.drawString( ( "Point: " + backgroundSpeed ), 100, 350 );
        
        g.setFont( new Font( "Courier New", Font.PLAIN, 23 ) );
        g.drawString( ( "(left click increase, right click decrease)" ), 4, 390 );
        g.drawString( ( "Try to get the other person to 10 or -10 " ), 25, 550 );
        g.drawString( ( " depending on what button you pressed" ), 25, 580 );

...
public class Gameplay  extends JPanel implements ActionListener 
{
	...
	{    		
		...
		g.drawString("Instructions", 685, 260);
		
		g.drawString("Player 1: ", 670, 310);
		g.drawString("[WASD] to move", 670, 345);
		g.drawString("and [R] to shoot", 670, 375);
		
		g.drawString("Player 2", 670, 425);
		g.drawString("[Arrows] to move", 670, 455);
		g.drawString("and [M] to shoot", 670, 485);
		
	    //------------\\
		g.setFont(new Font("serif",Font.BOLD, 13));
		
		g.drawString("Tap [WASD] keys... but dont hold", 2, 375);
		g.drawString("Try to Break These ---", 20, 200);
		g.setColor(Color.WHITE);
		g.drawString("SHOOT THE OTHER TANK 5 TIMES", 425,20 );
